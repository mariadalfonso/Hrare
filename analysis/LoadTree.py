...
def loadTree(mytree, directory , category, mesonCat, year ):
   ...
   if category=='_VBFcat':
      ...
      mytree.Add(directory+'outname_mc-5'+category+mesonCat+year+'.root')  #DATA
      mytree.Add(directory+'outname_mc-6'+category+mesonCat+year+'.root')  #DATA
      ...
      mytree.Add(directory+'outname_mc-15'+category+mesonCat+year+'.root')  #DATA
      mytree.Add(directory+'outname_mc-16'+category+mesonCat+year+'.root')  #DATA
      ...
      mytree.Add(directory+'outname_mc-25'+category+mesonCat+year+'.root')  #DATA
      mytree.Add(directory+'outname_mc-26'+category+mesonCat+year+'.root')  #DATA
