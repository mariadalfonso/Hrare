...
public:
  ...
  const std::string fileNameMU = dirName+"MUO/"+subDirName+"muon_Z.json.gz";
  ...
  */
  ...
  double eval_jer(double double1, double double2, double double3, double double4) {
        return JER_->evaluate({double1, double2, double3, double4});
  };

  double eval_jetVeto(std::string str1, double double1, double double2) {
  ...
  double eval_puSF(double int1, std::string str1) {
