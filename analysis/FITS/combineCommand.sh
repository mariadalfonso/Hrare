...
resultFile="results_NOV1.txt"
dataCardDIR="workspaces_NOV1"
bin=""

#wsDIR="WSmva_NOV1_neuIso"
#cardDIR="workspaces"
#resultDir="workspaces"
#resultFile="results_MVA_NOV1_neuIso.txt"
#dataCardDIR="workspaces_MVA_NOV1_neuIso"
#bin=""

#_neuIso
#wsDIR="WSmvaLowBin_NOV1_neuIso"
#cardDIR="workspaces"
#resultDir="workspaces"
#resultFile="results_MVALowBin_NOV1_neuIso.txt"
#dataCardDIR="workspaces_MVALowBin_NOV1_neuIso"
#bin="_bin1"
...
do
    ...
    python bwsHrare.py --whichBIN=$bin --whichMeson=_$meson\Cat --whichCat=GFcat --inputFileSig=$wsDIR/Signal_GFcat__$meson\Cat_2018$bin\_workspace.root --inputFileBKG=$wsDIR/Bkg_GFcat__$meson\Cat_2018$bin\_workspace.root --output=$cardDIR/workspace$bin\_$meson\_GFcat_2018.root --datCardName=$cardDIR/datacard$bin\_$meson\_GFcat_2018.txt

    python bwsHrare.py --whichBIN=$bin --whichMeson=_$meson\Cat --whichCat=VBFcatlow --inputFileSig=$wsDIR/Signal_VBFcatlow__$meson\Cat_2018$bin\_workspace.root --inputFileBKG=$wsDIR/Bkg_VBFcatlow__$meson\Cat_2018$bin\_workspace.root --output=$cardDIR/workspace$bin\_$meson\_VBFcatlow_2018.root --datCardName=$cardDIR/datacard$bin\_$meson\_VBFcatlow_2018.txt

    python bwsHrare.py --whichBIN=$bin --whichMeson=_$meson\Cat --whichCat=VBFcat --inputFileSig=$wsDIR/Signal_VBFcat__$meson\Cat_Run2$bin\_workspace.root --inputFileBKG=$wsDIR/Bkg_VBFcat__$meson\Cat_Run2$bin\_workspace.root --output=$cardDIR/workspace$bin\_$meson\_VBFcat_Run2.root --datCardName=$cardDIR/datacard$bin\_$meson\_VBFcat_Run2.txt
...
combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_Phi_GFcat_2018.txt -n PhiGFcat$bin --run expected >> $resultFile
combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_Rho_GFcat_2018.txt -n RhoGFcat$bin --run expected >> $resultFile
combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_K0Star_GFcat_2018.txt -n K0StarGFcat$bin --run expected >> $resultFile

echo ' **** VBFcatlow ****' >> $resultFile

combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_Phi_VBFcatlow_2018.txt -n PhiVBFcatlow$bin --run expected >> $resultFile
combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_Rho_VBFcatlow_2018.txt -n RhoVBFcatlow$bin --run expected >> $resultFile
combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_K0Star_VBFcatlow_2018.txt -n K0StarVBFcatlow$bin --run expected >> $resultFile

echo ' **** VBFcat ****' >> $resultFile

combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_Phi_VBFcat_Run2.txt -n PhiVBFcat --run expected >> $resultFile
combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_Rho_VBFcat_Run2.txt -n RhoVBFcat --run expected >> $resultFile
combine -M AsymptoticLimits -m 125 -t -1 $cardDIR/datacard$bin\_K0Star_VBFcat_Run2.txt -n K0StarVBFcat --run expected >> $resultFile
...
cp -r $dataCardDIR /work/submit/mariadlf/cards_NOV1/$dataCardDIR
