...
#            '23:onMode = off',
#            '23:onIfMatch = 5 -5',
            '25:addChannel = 1  1.00   103   22   423', ##D*(2007) is 423
            # D*(2007) decay to D0 + (pion0 or Gamma) : D0 is 421
            '421:onMode = off', 
            '421:onIfMatch = -321 211 111', # D0 to k- rho+ (with Rho+ BR = 11.20 and non resonant BR = 1.14)
