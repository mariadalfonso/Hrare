...
#            '23:onMode = off',
#            '23:onIfMatch = 5 -5',
            '25:addChannel = 1  1.00   103   22   113', ##rho(770) is 113
#            '25:onIfMatch = 22 113',  ##rho(770) gamma
            '113:onMode = off', 
            '113:onIfMatch = 211 -211',
#            '24:onMode = off',   # first, turn off all Z decays
#            '24:onIfAny = 11 13 15', # turn on only decays to leptons
        ),
...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/powheg/V2/HWJ_slc7_amd64_gcc700_CMSSW_10_6_27_WminusH_HToBB_WToLNu_M125_13TeV_powheg/v1/HWJ_slc7_amd64_gcc700_CMSSW_10_6_27_WminusH_HToBB_WToLNu_M125_13TeV_powheg.tgz'),
